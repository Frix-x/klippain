...
For ERCF users with Happy Hare config installed, you must specify INITIAL_TOOL in your slicer start G-code. Base on the previous example for SuperSlicer:
```
